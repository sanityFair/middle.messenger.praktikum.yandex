                ...
                <div class={{styles.change-profile-page}}>
                    ...
                    <div class={{styles.change-profile-wrapper}}>
                        ...
                        <form>
                            <fieldset>
                                <label>Почта</label>
                                {{{ Input inputName="email" type="text" className=styles.input value="mail@mail.ru" required="true"  }}}
                            </fieldset>
                             <fieldset>
                                <label>Логин</label>
                                {{{ Input inputName="login" type="text" className=styles.input value="ivanivanov" required="true" }}}
                            </fieldset>
                            <fieldset>
                                <label>Имя</label>
                                {{{ Input inputName="second_name" type="text" className=styles.input value="Иван" required="true"  }}}
                            </fieldset>
                              <fieldset>
                                <label>Фамилия</label>
                                {{{ Input inputName="first_name" type="text" className=styles.input value="Иванов" required="true" }}}
                            </fieldset>
                              <fieldset>
                                <label>Имя в чате</label>
                                {{{ Input inputName="display_name" type="text" className=styles.input value="Ivan" required="true" }}}
                            </fieldset>
                             <fieldset>
                                <label>Телефон</label>
                                {{{ Input inputName="phone" type="text" className=styles.input value="+79090876754" required="true"  }}}
                            </fieldset>
